...
### � Испчравления
- ✅ **Исправлен баг с состоянием VPN на Android**
  - Добавлен метод `isRunning` для проверки статуса VPN сервиса
  - Приложение восстанавливает состояние VPN при перезапуске
  - Исправлена синхронизация между сервисом и UI
  
- ✅ **Исправлено обновление на Windows**
  - Убрана автоматическая попытка запуска .exe
...
### 📝 Документация
- ✅ Обновлена терминология в документации
